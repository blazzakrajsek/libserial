...
protected:
     ...
     */
    bool getPortSettings(DCB& portSettings) const;
     ...
     * @param portSettings Serial port settings
     */
    void preparePortSettings(DCB& portSettings) const;
     ...
     */
    bool setPortSettings(DCB& portSettings) const;

    /**
     * @brief Get the serial port timeout settings
     *
     * @param timeoutSettings Timeout settings
     * @return true Successfully obtained timeout settings
     * @return false Failed to obtain timeout settings
     */
    bool getPortTimeoutSettings(COMMTIMEOUTS& timeoutSettings) const;

    /**
     * @brief Prepare/update timeout settings
     *
     * @param timeoutSettings Timeout settings
     */
    void preparePortTimeoutSettings(COMMTIMEOUTS& timeoutSettings) const;

    /**
     * @brief Set the serial port timeout settings
     *
     * @param timeoutSettings Timeout settings
     * @return true Successfully applied timeout settings
     * @return false Failed to apply timeout settings
     */
    bool setPortTimeoutSettings(COMMTIMEOUTS& timeoutSettings) const;
